...
export class LocationSandbox extends Sandbox {
  ...
  constructor(protected store: Store<LocationState>, protected injector: Injector) {
    super(injector);
  }
  ...
  fetchCities(criteria: RequestCriteria<SearchCityForm>): void {
    this.store.dispatch(locationActions.doFetchCities({ requestCriteria: criteria }));
  }
  ...
  fetchCountries(criteria: RequestCriteria<SearchCountryForm>): void {
    this.store.dispatch(locationActions.doFetchCountries({ requestCriteria: criteria }));
  }
   ...
   */
  createCountry(form: Country): void {
   ...
   */
  updateCountry(form: Country): void {
  ...
  fetchLocations(criteria: RequestCriteria<SearchLocationForm>): void {
    this.store.dispatch(locationActions.doFetchLocations({ requestCriteria: criteria }));
  }
   ...
   */
  createLocation(form: Location): void {
   ...
   */
  updateLocation(form: Location): void {
  ...
  fetchStates(criteria: RequestCriteria<SearchStateForm>): void {
    this.store.dispatch(locationActions.doFetchStates({ requestCriteria: criteria }));
  }
